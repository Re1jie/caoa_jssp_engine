...
def main():
    ...
    caoa_ssr_params = {
        ...
        'structural_distance_threshold': 0.18,
        ...
        'ssr_kdr_rate': 0.65,
        'ssr_kdr_elite_size': 2,
        'ssr_kdr_noise_scale': 0.10,
        'ssr_kdr_stability_threshold': 0.93,
        'ssr_kdr_uniform_mix': 0.38,
        'ssr_kdr_bottleneck_perturbation': 0.55,
    }
